...
const ERR_MSG: Record<SpotFormError, string> = {
  ...
  LOCATION_REQUIRED: '위치를 지정하세요 — 검색해서 결과를 고르면 됩니다'
};
...
const SEARCH_ERR_MSG: Record<SearchError, string> = {
  ...
  error: '검색에 실패했어요 — 다시 시도하거나 기존 앱의 지도 클릭으로 지정해주세요'
};
...
export function SpotEditor({ spot, di, days, isNew = false, onSave, onDelete, onCancel }: {
