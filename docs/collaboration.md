# 함께하기 (Collaborative Trip Planning) — 1단계: 멤버십 · 권한 · 초대 / 2단계: 후보 · 반응 / 3단계: 코멘트 · 활동 · 실시간 / 4단계: 취향 · 합의
...
후보 장소·의견(2단계), 코멘트·활동 기록·실시간(3단계), 여행 취향·그룹 컨텍스트·합의(4단계)가 그 위에 올라갔다(아래). 충돌 해결 선택지·일정 제안·분리 활동은 다음 단계다.
...
- 취향은 그룹 요약에만 쓰이고 **후보 합의 점수에는 아직 안 들어간다** — 후보에 카테고리가 없다. 충돌 해결 선택지(§24 함께 방문/분리/제외)와 "Day 2 오후에 넣으면…" 같은 제안은 다음 단계.
